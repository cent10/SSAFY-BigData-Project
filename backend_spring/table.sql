...
(
    ...
    TYPE3 VARCHAR(50) NOT NULL,
    PRIMARY KEY (ID),
    CONSTRAINT FK_COACHS_CLASSES FOREIGN KEY (COACH_ID) REFERENCES COACHES (UID)
        ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    STANDING_JUMP INT DEFAULT NULL,
    TWIST_SIT_UP INT DEFAULT NULL,
    SQUAT INT DEFAULT NULL,
    BMI FLOAT NOT NULL,
    RUNNING_JUMP INT DEFAULT NULL,
