...
function MainNav() {
  ...
  return (
    <div className={`nav__main ${show && "nav__white"}`}>
      {isUserLoggedIn &&<Link className="nav__linkmain" to={"/main"}>
        <img src={logo} alt="PTS logo" className="nav__logo" />
      </Link>}
      {!isUserLoggedIn &&<Link className="nav__linkmain" to={"/"}>
        <img src={logo} alt="PTS logo" className="nav__logo" />
      </Link>}
      ...
      <div className="nav__right">
        ...
        {isUserLoggedIn && <Icon className="nav__search" icon={cardSearch} />}
        {isUserLoggedIn && <Link to={"/"} onClick={AuthenticationService.logout}><button className="start-button">Logout</button></Link>}
        {isUserLoggedIn && (
          <img
